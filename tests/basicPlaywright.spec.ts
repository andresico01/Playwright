...
test('Find a env sending for command line', async () => {

    const envValue = (globalThis as any).process?.env?.TEST || 'Problem to get the env variable';
    console.log(`Value of TEST: ${envValue}`);
